...
const ROLE_NAV: Record<string, NavItem[]> = {
  ...
  // Store user routes
  store: [
    { icon: <BoxCubeIcon />, name: "Dashboard", path: "/store" },
    { icon: <TableIcon />, name: "Inventory Store", path: "/store/inventory" },
    { icon: <BoxCubeIcon />, name: "Request", path: "/store/request" },
  ],
 ...
 * --------------------------------------------- */
const AppSidebarStore: React.FC = () => {
...
export default AppSidebarStore;
