...
const ROLE_NAV: Record<string, NavItem[]> = {
  ...
  owner: [
    { icon: <BoxCubeIcon />, name: "Dashboard", path: "/owner/dashboard" },
    { icon: <PageIcon />, name: "Request", path: "/owner/requests" },
    { icon: <TableIcon />, name: "Inventory", path: "/owner/inventory" },
  ],

  // Admin has its own admin routes (different paths)
  admin: [
    { icon: <BoxCubeIcon />, name: "Dashboard", path: "/admin" },
    { icon: <PageIcon />, name: "Request", path: "/request-admin" },
    { icon: <TableIcon />, name: "Inventory Store", path: "/inventory-store" },
  ],

  // Kitchen user routes
  kitchen: [
    { icon: <BoxCubeIcon />, name: "Dashboard", path: "/kitchen" },
  ],

  // Marketing routes
  marketing: [
    { icon: <BoxCubeIcon />, name: "Dashboard", path: "/marketing" },
    { icon: <PageIcon />, name: "Target Prodcution Plan", path: "/marketing/brands" },
    // { icon: <TableIcon />, name: "Surat Jalan", path: "/marketing/ql-list" },
  ],
 ...
 * --------------------------------------------- */
const AppSidebarCentral: React.FC = () => {
...
export default AppSidebarCentral;
