...
const defaultInitialData: Order[] = [
  ...
  {
    id: 1,
    user: { image: "/images/user/user-17.jpg", name: "Plain Dough", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 2,
    user: { image: "/images/user/user-18.jpg", name: "Chocolate Dough", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 3,
    user: { image: "/images/user/user-17.jpg", name: "Red Velvet Dough", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 4,
    user: { image: "/images/user/user-20.jpg", name: "Pandian Dough", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 5,
    user: { image: "/images/user/user-21.jpg", name: "Charcoal Dough", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
    {
    id: 6,
    user: { image: "/images/user/user-21.jpg", name: "Snow Bun (Kelipatan 125)", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
];
        ...
        <Table>
          <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
              ...
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Dough 32 - 430 pax</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Dough 16 - 215 pax</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Dough 8 - 107 pax</TableCell>
            </TableRow>
          </TableHeader>
