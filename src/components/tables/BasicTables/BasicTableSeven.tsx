...
const defaultInitialData: Order[] = [
  ...
  {
    id: 1,
    user: { image: "/images/user/user-17.jpg", name: "Tanpa Filling", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 2,
    user: { image: "/images/user/user-18.jpg", name: "Milk Butter", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 3,
    user: { image: "/images/user/user-17.jpg", name: "Milk Butter Raisin", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 4,
    user: { image: "/images/user/user-20.jpg", name: "Cinnaman Butter", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 5,
    user: { image: "/images/user/user-21.jpg", name: "Chocolate Butter", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 6,
    user: { image: "/images/user/user-21.jpg", name: "Black Butter", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
  {
    id: 7,
    user: { image: "/images/user/user-21.jpg", name: "Aren", role: "" },
    projectName: 32, team: 12, budget: 9, status: 40, plusone: 20, plustwo: 31, plusthree: 29, plusfour: 21,
  },
];
...
export default function BasicTableSeven({
  editable = false,
  onChange,
  highlightDate,
  initialData,
        ...
        <Table>
          <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
              ...
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Plain Dough</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Chocolate Dough</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Red Velvet Dough</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Pandan Dough</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Charcoal DOugh</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Snow Bun Dough</TableCell>
            </TableRow>
          </TableHeader>
