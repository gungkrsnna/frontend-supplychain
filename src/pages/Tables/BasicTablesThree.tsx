...
import BasicTableSix from "../../components/tables/BasicTables/BasicTableSix";
...
export default function BasicTablesThree(): JSX.Element {
  ...
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle="Target Produksi Kitchen" />

      <div className="space-y-6">
        <ComponentCard title="Dough (Loyang)">
      ...
      <div className="space-y-6">
        <ComponentCard title="Filling (Gram)">
          <div className="mb-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">{note}</div>
              <div className="mt-2 flex items-center gap-3">
      ...
      <div className="space-y-6">
        <ComponentCard title="Dough Filling (Loyang)">
          <div className="mb-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">{note}</div>
              <div className="mt-2 flex items-center gap-3">
      ...
      <div className="space-y-6">
        <ComponentCard title="Toping Manis">
          <div className="mb-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">{note}</div>
              <div className="mt-2 flex items-center gap-3">
      ...
      <div className="space-y-6">
        <ComponentCard title="Toping Asin">
          <div className="mb-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">{note}</div>
              <div className="mt-2 flex items-center gap-3">
      ...
      <div className="space-y-6">
        <ComponentCard title="Toping Bahan Raw Material">
          <div className="mb-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <div className="text-sm text-gray-600">{note}</div>
              <div className="mt-2 flex items-center gap-3">
